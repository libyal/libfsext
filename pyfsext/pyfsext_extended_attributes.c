...
PySequenceMethods pyfsext_extended_attributes_sequence_methods = {
	/* sq_length */
	(lenfunc) pyfsext_extended_attributes_len,
	/* sq_concat */
	0,
	/* sq_repeat */
	0,
	/* sq_item */
	(ssizeargfunc) pyfsext_extended_attributes_getitem,
	/* sq_slice */
	0,
	/* sq_ass_item */
	0,
...
PyTypeObject pyfsext_extended_attributes_type_object = {
	PyVarObject_HEAD_INIT( NULL, 0 )

	/* tp_name */
	"pyfsext.extended_attributes",
	/* tp_basicsize */
	sizeof( pyfsext_extended_attributes_t ),
	/* tp_itemsize */
	0,
	/* tp_dealloc */
	(destructor) pyfsext_extended_attributes_free,
	/* tp_print */
	0,
	/* tp_getattr */
	0,
	...
	0,
	/* tp_as_sequence */
	&pyfsext_extended_attributes_sequence_methods,
	/* tp_as_mapping */
	0,
	/* tp_hash */
	0,
	...
	/* tp_doc */
	"pyfsext sequence and iterator object of extended attributes",
	/* tp_traverse */
	0,
	/* tp_clear */
	0,
	...
	0,
	/* tp_iter */
	(getiterfunc) pyfsext_extended_attributes_iter,
	/* tp_iternext */
	(iternextfunc) pyfsext_extended_attributes_iternext,
	/* tp_methods */
	0,
	/* tp_members */
	0,
	...
	0,
	/* tp_init */
	(initproc) pyfsext_extended_attributes_init,
	/* tp_alloc */
	0,
	/* tp_new */
	0,
...
PyObject *pyfsext_extended_attributes_new(
           ...
           int number_of_items )
{
	pyfsext_extended_attributes_t *sequence_object = NULL;
	static char *function                           = "pyfsext_extended_attributes_new";
...
{
	static char *function = "pyfsext_extended_attributes_init";
      ...
      pyfsext_extended_attributes_t *sequence_object )
{
	...
	static char *function       = "pyfsext_extended_attributes_free";
...
Py_ssize_t pyfsext_extended_attributes_len(
            pyfsext_extended_attributes_t *sequence_object )
{
	static char *function = "pyfsext_extended_attributes_len";
           ...
           Py_ssize_t item_index )
{
	...
	static char *function               = "pyfsext_extended_attributes_getitem";
...
PyObject *pyfsext_extended_attributes_iter(
           pyfsext_extended_attributes_t *sequence_object )
{
	static char *function = "pyfsext_extended_attributes_iter";
...
{
	PyObject *extended_attribute_object = NULL;
	static char *function               = "pyfsext_extended_attributes_iternext";
