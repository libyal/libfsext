...
PyMethodDef pyfsext_extended_attribute_object_methods[] = {

	{ "get_name",
	  (PyCFunction) pyfsext_extended_attribute_get_name,
	  METH_NOARGS,
	...
	{ "get_offset",
	  (PyCFunction) pyfsext_extended_attribute_get_offset,
	  METH_NOARGS,
	  "get_offset() -> Integer\n"
	  "\n"
	...
	{ "get_size",
	  (PyCFunction) pyfsext_extended_attribute_get_size,
	  METH_NOARGS,
	  "get_size() -> Integer\n"
	  "\n"
...
PyGetSetDef pyfsext_extended_attribute_object_get_set_definitions[] = {

	{ "name",
	  (getter) pyfsext_extended_attribute_get_name,
	  (setter) 0,
	  "The name.",
	  NULL },

	{ "size",
	  (getter) pyfsext_extended_attribute_get_size,
	  (setter) 0,
...
PyTypeObject pyfsext_extended_attribute_type_object = {
	PyVarObject_HEAD_INIT( NULL, 0 )

	/* tp_name */
	"pyfsext.extended_attribute",
	/* tp_basicsize */
	sizeof( pyfsext_extended_attribute_t ),
	/* tp_itemsize */
	0,
	/* tp_dealloc */
	(destructor) pyfsext_extended_attribute_free,
	/* tp_print */
	0,
	/* tp_getattr */
	0,
	...
	Py_TPFLAGS_DEFAULT,
	/* tp_doc */
	"pyfsext extended attribute object (wraps libfsext_extended_attribute_t)",
	/* tp_traverse */
	0,
	/* tp_clear */
	0,
	...
	0,
	/* tp_methods */
	pyfsext_extended_attribute_object_methods,
	/* tp_members */
	0,
	/* tp_getset */
	pyfsext_extended_attribute_object_get_set_definitions,
	/* tp_base */
	0,
	/* tp_dict */
	0,
	...
	0,
	/* tp_init */
	(initproc) pyfsext_extended_attribute_init,
	/* tp_alloc */
	0,
	/* tp_new */
	0,
...
{
	pyfsext_extended_attribute_t *pyfsext_extended_attribute = NULL;
	static char *function                                      = "pyfsext_extended_attribute_new";
	 ...
	 */
	pyfsext_extended_attribute = PyObject_New(
	                               struct pyfsext_extended_attribute,
	                               &pyfsext_extended_attribute_type_object );
	...
	pyfsext_extended_attribute->extended_attribute = extended_attribute;
	pyfsext_extended_attribute->parent_object      = parent_object;

	if( pyfsext_extended_attribute->parent_object != NULL )
	{
		Py_IncRef(
		 pyfsext_extended_attribute->parent_object );
	}
	return( (PyObject *) pyfsext_extended_attribute );

on_error:
	if( pyfsext_extended_attribute != NULL )
	{
		Py_DecRef(
		 (PyObject *) pyfsext_extended_attribute );
	}
	return( NULL );
}
...
{
	static char *function = "pyfsext_extended_attribute_init";
	...
	/* Make sure libfsext extended attribute is set to NULL
	 */
	pyfsext_extended_attribute->extended_attribute = NULL;
      ...
      pyfsext_extended_attribute_t *pyfsext_extended_attribute )
{
	...
	static char *function       = "pyfsext_extended_attribute_free";
	int result                  = 0;
	...
	if( pyfsext_extended_attribute->extended_attribute != NULL )
	{
		...
		if( result != 1 )
		{
			pyfsext_error_raise(
			 error,
			 PyExc_MemoryError,
			 "%s: unable to free libfsext extended attribute.",
			 function );
           ...
           PyObject *arguments PYFSEXT_ATTRIBUTE_UNUSED )
{
	...
	libcerror_error_t *error = NULL;
	static char *function    = "pyfsext_extended_attribute_get_name";
           ...
           PyObject *keywords )
{
	...
	libcerror_error_t *error    = NULL;
	char *buffer                = NULL;
	static char *function       = "pyfsext_extended_attribute_read_buffer";
	      ...
	      || ( integer_object == Py_None ) )
	{
		...
		result = libfsext_extended_attribute_get_size(
		          pyfsext_extended_attribute->extended_attribute,
		          (size64_t *) &read_size,
		          &error );
	...
	read_count = libfsext_extended_attribute_read_buffer(
	              pyfsext_extended_attribute->extended_attribute,
	              (uint8_t *) buffer,
	              (size_t) read_size,
	              &error );
           ...
           PyObject *keywords )
{
	...
	libcerror_error_t *error    = NULL;
	char *buffer                = NULL;
	static char *function       = "pyfsext_extended_attribute_read_buffer_at_offset";
...
{
	libcerror_error_t *error    = NULL;
	static char *function       = "pyfsext_extended_attribute_seek_offset";
	...
	offset = libfsext_extended_attribute_seek_offset(
	          pyfsext_extended_attribute->extended_attribute,
	          offset,
	          whence,
	          &error );
           ...
           PyObject *arguments PYFSEXT_ATTRIBUTE_UNUSED )
{
	PyObject *integer_object = NULL;
	libcerror_error_t *error = NULL;
	static char *function    = "pyfsext_extended_attribute_get_offset";
	off64_t offset           = 0;
	int result               = 0;
	...
	result = libfsext_extended_attribute_get_offset(
	          pyfsext_extended_attribute->extended_attribute,
	          &offset,
	          &error );
           ...
           PyObject *arguments PYFSEXT_ATTRIBUTE_UNUSED )
{
	PyObject *integer_object = NULL;
	libcerror_error_t *error = NULL;
	static char *function    = "pyfsext_extended_attribute_get_size";
	size64_t size            = 0;
	int result               = 0;
