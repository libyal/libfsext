...
#endif
{
	...
	/* TODO: add tests for libfsext_io_handle_clear */

	/* TODO: add tests for libfsext_io_handle_read_superblock */

	/* TODO: add tests for libfsext_io_handle_read_group_descriptor */
