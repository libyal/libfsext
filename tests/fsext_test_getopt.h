...
#if !defined( _FSEXT_TEST_GETOPT_H )
#define _FSEXT_TEST_GETOPT_H
...
#define fsext_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t fsext_test_getopt(
                  int argument_count,
...
#endif /* !defined( _FSEXT_TEST_GETOPT_H ) */
