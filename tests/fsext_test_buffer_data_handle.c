...
#include "../libfsext/libfsext_buffer_data_handle.h"

#if defined( __GNUC__ ) && !defined( LIBFSEXT_DLL_IMPORT )

/* Tests the libfsext_buffer_data_handle_free function
 * Returns 1 if successful or 0 if not
 */
int fsext_test_buffer_data_handle_free(
     void )
{
	...
	/* Test error cases
	 */
	result = libfsext_buffer_data_handle_free(
	          NULL,
	          &error );
...
#endif
{
	...
	/* TODO: add tests for libfsext_buffer_data_handle_initialize */

	FSEXT_TEST_RUN(
	 "libfsext_buffer_data_handle_free",
	 fsext_test_buffer_data_handle_free );

	/* TODO: add tests for libfsext_buffer_data_handle_read_segment_data */

	/* TODO: add tests for libfsext_buffer_data_handle_seek_segment_offset */
