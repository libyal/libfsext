...
uint8_t fsext_test_bitmap_data1[ 1024 ] = {
...
/* Tests the libfsext_bitmap_read_data function
 * Returns 1 if successful or 0 if not
 */
int fsext_test_bitmap_read_data(
     void )
{
	libcerror_error_t *error  = NULL;
	libfsext_bitmap_t *bitmap = NULL;
	...
	/* Test regular cases
	 */
	result = libfsext_bitmap_read_data(
	          bitmap,
	          fsext_test_bitmap_data1,
	          1024,
	          &error );
...
/* Tests the libfsext_bitmap_read_file_io_handle function
 * Returns 1 if successful or 0 if not
 */
int fsext_test_bitmap_read_file_io_handle(
     void )
{
...
#endif
{
	...
	FSEXT_TEST_RUN(
	 "libfsext_bitmap_read_data",
	 fsext_test_bitmap_read_data );

	FSEXT_TEST_RUN(
	 "libfsext_bitmap_read_file_io_handle",
	 fsext_test_bitmap_read_file_io_handle );
