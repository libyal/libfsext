...
#include "../libfsext/libfsext_extents_footer.h"

#if defined( __GNUC__ ) && !defined( LIBFSEXT_DLL_IMPORT )

/* Tests the libfsext_extents_footer_initialize function
 * Returns 1 if successful or 0 if not
 */
int fsext_test_extents_footer_initialize(
     void )
{
	...
	/* Test regular cases
	 */
	result = libfsext_extents_footer_initialize(
	          &extents_footer,
	          &error );
	...
	result = libfsext_extents_footer_free(
	          &extents_footer,
	          &error );
	...
	extents_footer = (libfsext_extents_footer_t *) 0x12345678UL;
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libfsext_extents_footer_initialize with malloc failing
		 */
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libfsext_extents_footer_initialize with memset failing
		 */
 ...
 * Returns 1 if successful or 0 if not
 */
int fsext_test_extents_footer_free(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
#endif
{
	...
	FSEXT_TEST_RUN(
	 "libfsext_extents_footer_initialize",
	...
	/* TODO: add tests for libfsext_extents_footer_read_data */
