...
void (*fsexttools_signal_signal_handler)( fsexttools_signal_t ) = NULL;
             ...
             fsexttools_signal_t signal )
{
	...
	switch( signal )
	{
		...
		case CTRL_C_EVENT:
			if( fsexttools_signal_signal_handler != NULL )
			{
...
{
	static char *function = "fsexttools_signal_attach";
...
#if defined( _MSC_VER )
	fsexttools_signal_initialize_memory_debug();
#endif
     ...
     libcerror_error_t **error )
{
	...
	fsexttools_signal_signal_handler = NULL;
