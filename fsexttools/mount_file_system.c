     ...
     libcerror_error_t **error )
{
	...
	if( file_system->fsext_volume != NULL )
	{
		if( libfsext_volume_signal_abort(
		     file_system->fsext_volume,
		     error ) != 1 )
		{
			libcerror_error_set(
			 error,
...
int mount_file_system_set_volume(
     mount_file_system_t *file_system,
     libfsext_volume_t *fsext_volume,
     libcerror_error_t **error )
{
	...
	file_system->fsext_volume = fsext_volume;
     ...
     libcerror_error_t **error )
{
	...
	*fsext_volume = file_system->fsext_volume;
...
int mount_file_system_get_file_entry_by_path(
     ...
     size_t path_length,
     libfsext_file_entry_t **fsext_file_entry,
     libcerror_error_t **error )
{
