/*
 * Common output functions for the fsexttools
 *
...
#include "fsexttools_libfcache.h"
#include "fsexttools_libfdata.h"
 ...
 */
int fsexttools_output_initialize(
     int stdio_mode,
     libcerror_error_t **error )
{
	static char *function = "fsexttools_output_initialize";
 ...
 */
void fsexttools_output_copyright_fprint(
      FILE *stream )
{
	if( stream == NULL )
	{
 ...
 */
void fsexttools_output_version_fprint(
      FILE *stream,
      const char *program )
{
	if( stream == NULL )
 ...
 */
void fsexttools_output_version_detailed_fprint(
      FILE *stream,
      const char *program )
{
	if( stream == NULL )
