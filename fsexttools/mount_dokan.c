...
int __stdcall mount_dokan_CreateFile(
               ...
               DWORD share_mode FSEXTTOOLS_ATTRIBUTE_UNUSED,
               DWORD creation_disposition,
               DWORD attribute_flags FSEXTTOOLS_ATTRIBUTE_UNUSED,
               DOKAN_FILE_INFO *file_info )
{
	...
	FSEXTTOOLS_UNREFERENCED_PARAMETER( share_mode )
	FSEXTTOOLS_UNREFERENCED_PARAMETER( attribute_flags )
...
NTSTATUS __stdcall mount_dokan_ZwCreateFile(
                    const wchar_t *path,
                    DOKAN_IO_SECURITY_CONTEXT *security_context FSEXTTOOLS_ATTRIBUTE_UNUSED,
                    ACCESS_MASK desired_access,
                    ULONG file_attributes FSEXTTOOLS_ATTRIBUTE_UNUSED,
                    ULONG share_access FSEXTTOOLS_ATTRIBUTE_UNUSED,
                    ULONG creation_disposition,
                    ULONG creation_options FSEXTTOOLS_ATTRIBUTE_UNUSED,
                    DOKAN_FILE_INFO *file_info )
{
	libcerror_error_t *error = NULL;
	...
	FSEXTTOOLS_UNREFERENCED_PARAMETER( security_context )
	FSEXTTOOLS_UNREFERENCED_PARAMETER( file_attributes )
	FSEXTTOOLS_UNREFERENCED_PARAMETER( share_access )
	FSEXTTOOLS_UNREFERENCED_PARAMETER( creation_options )
...
int __stdcall mount_dokan_GetFileInformation(
               const wchar_t *path,
               BY_HANDLE_FILE_INFORMATION *file_information,
               DOKAN_FILE_INFO *file_info FSEXTTOOLS_ATTRIBUTE_UNUSED )
#else
...
#endif
{
	...
	FSEXTTOOLS_UNREFERENCED_PARAMETER( file_info )
