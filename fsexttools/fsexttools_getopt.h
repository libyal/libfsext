...
#if !defined( _FSEXTTOOLS_GETOPT_H )
...
typedef struct fsexttools_option fsexttools_option_t;

struct fsexttools_option
{
...
#define fsexttools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t fsexttools_getopt(
                  int argument_count,
...
void fsexttools_getopt_wrapped_fprint(
      FILE *stream,
...
void fsexttools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const fsexttools_option_t *options,
      int number_of_options );

int fsexttools_getopt_get_options_string(
     const fsexttools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _FSEXTTOOLS_GETOPT_H ) */
