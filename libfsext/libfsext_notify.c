...
{
	static char *function = "libfsext_notify_set_stream";
...
int libfsext_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libfsext_notify_stream_open";
...
int libfsext_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libfsext_notify_stream_close";
