...
#if !defined( _LIBFSEXT_LIBCTHREADS_H )
#define _LIBFSEXT_LIBCTHREADS_H

#include <common.h>

#if defined( HAVE_MULTI_THREAD_SUPPORT ) && !defined( HAVE_LOCAL_LIBFSEXT )
#define HAVE_LIBFSEXT_MULTI_THREAD_SUPPORT
#endif
...
#endif /* defined( HAVE_LIBFSEXT_MULTI_THREAD_SUPPORT ) */

#endif /* !defined( _LIBFSEXT_LIBCTHREADS_H ) */
