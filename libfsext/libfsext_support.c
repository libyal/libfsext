...
const char *libfsext_get_version(
             void )
{
	return( (const char *) LIBFSEXT_VERSION_STRING );
}
...
int libfsext_get_access_flags_read(
     void )
{
	return( (int) LIBFSEXT_ACCESS_FLAG_READ );
}
...
{
	static char *function = "libfsext_get_codepage";
...
int libfsext_set_codepage(
     ...
     libcerror_error_t **error )
{
	static char *function = "libfsext_set_codepage";
     ...
     libcerror_error_t **error )
{
	...
	static char *function            = "libfsext_check_volume_signature";
...
{
	libbfio_handle_t *file_io_handle = NULL;
	static char *function            = "libfsext_check_volume_signature_wide";
	size_t filename_length           = 0;
	int result                       = 0;
     ...
     libcerror_error_t **error )
{
	...
	static char *function      = "libfsext_check_volume_signature_file_io_handle";
	...
	if( read_count != 2 )
	{
		libcerror_error_set(
		 ...
		 "%s: unable to read signature at offset: 1080 (0x00000438).",
		 function );
